...
class GCNClassifier(
    ...
    def __init__(
        ...
        results_function=utils.get_binary_classif_results,
    ):
        super().__init__()
        self.model = model
    ...
    def validation_step(self, batch: Batch, _: int) -> Mapping[str, torch.Tensor]:  # type: ignore
    ...
    def validation_epoch_end(self, outputs: List[Tensor | Dict[str, Any]]) -> None:
        """Computes average validation loss.
        Args:
            outputs: Outputs after every epoch end.
        """
